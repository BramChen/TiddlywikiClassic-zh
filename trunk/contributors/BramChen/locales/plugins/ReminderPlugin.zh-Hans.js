...
if (typeof config.macros.reminders != "undefined"){
	...
	config.macros.newReminder.handler = function newReminder(place,macroName,params){
		...
		formstring += '</select>&nbsp;&nbsp;事件标题：<input type="text" size="40" name="title" value="请输入事件标题" onfocus="this.select();"><input type="button" value="确定" onclick="addReminderToTiddler(this.form)"></form></html>';
